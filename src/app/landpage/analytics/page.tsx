      ...
      <div className="bg-gray-100 p-6 text-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-justify mt-2">
            ...
            çalışanların, müşterilerin ve diğer bireylerin güvenliğini sağlamak,
            mülk kaybını önlemek ve yangının yayılma hızını yavaşlatmak amacıyla
            yapılır.
          </p>
          ...
          <ul className="list-disc list-inside mt-2">
            ...
            <li className="ml-4">
              Kapsamın Tanımlanması: Risk analizi sadece yangın tehlikeleri ile
              sınırlı kalmamalıdır. Ayrıca yangın güvenlik önlemleri, yangın
              söndürücüler, alarm sistemleri, tahliye planları gibi alanlar da
              kapsanmalıdır.
            </li>
          </ul>
          ...
          <p className="text-justify mt-2">
            Yangın çıkma olasılığını artırabilecek tüm faktörler belirlenir. Bu
            adımda şunlar göz önünde bulundurulmalıdır:
          </p>
          <ul className="list-disc list-inside mt-2">
            <li className="ml-4">
              Yangın Kaynakları: Elektrik arızaları, ısınma sistemleri, kimyasal
              maddeler, açık alevler gibi unsurlar.
            </li>
            <li className="ml-4">
            ...
            <li className="ml-4">
              Elektrik Tesisatları ve Cihazlar: Kısa devre, eski tesisatlar gibi
          ...
          <ul className="list-disc list-inside mt-2">
            ...
            <li className="ml-4">
              <strong>Hibrit Yöntem:</strong> Hem nicel hem de nitel bilgilerin
              birleşimi ile yapılan değerlendirme.
            </li>
          </ul>
