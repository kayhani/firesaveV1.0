      ...
      <div className="bg-gray-100 p-6 text-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-justify mt-2">
            ...
            firmadır. Kuruluşumuz, işletmelerin ve bireylerin güvenliğini en üst
            düzeyde sağlamak için danışmanlık, eğitim ve teknoloji hizmetlerini
          ...
          <ul className="list-disc list-inside mt-2">
            <li className="ml-4">
              ...
              İşletmelere özel yangın risk analizi ve yönetimi, yangın güvenlik
              sistemlerinin tasarımı ve denetimi.
            </li>
            <li className="ml-4">
              <strong>Eğitim Programları:</strong>
              Yangın önleme ve müdahale eğitimi, acil durum ve tahliye
              tatbikatları, çalışan farkındalığını artırmaya yönelik sertifikalı
              eğitimler.
            </li>
            <li className="ml-4">
          ...
          <ul className="list-disc list-inside mt-2">
            ...
            <li className="ml-4">
              <strong>Kapsamlı Çözümler:</strong> Danışmanlık, eğitim ve yazılım
              entegrasyonu ile 360 derece güvenlik hizmeti.
            </li>
            <li className="ml-4">
